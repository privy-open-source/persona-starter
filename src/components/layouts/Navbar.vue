...
import { ref } from 'vue'
import PiMenuBurger20 from '@privyid/persona-icon/vue/menu-burger/20.vue'
import PiMenuApp20 from '@privyid/persona-icon/vue/menu-app/20.vue'
import PiQuestionCircle20 from '@privyid/persona-icon/vue/question-circle/20.vue'
import LayoutsNavbarSwitchApp from './NavbarSwitchApp.vue'
import LayoutsNavbarProfile from './NavbarProfile.vue'
